...
namespace Crm.v1.Clients.Clients.Products.Clients
{
    public class ProductStatusesClient : IProductStatusesClient
    {
        ...
        public Task<ProductStatus> GetAsync(Guid id, Dictionary<string, string> headers, CancellationToken ct = default)
        {
        ...
        public Task<Guid> CreateAsync(
            ...
            CancellationToken ct = default)
        {
            return _httpClientFactory.PutJsonAsync<Guid>(UriBuilder.Combine(_url, "Create"), status, headers, ct);
        }
