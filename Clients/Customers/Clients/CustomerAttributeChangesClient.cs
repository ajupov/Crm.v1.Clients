...
namespace Crm.v1.Clients.Clients.Customers.Clients
{
    public class CustomerAttributeChangesClient : ICustomerAttributeChangesClient
    {
        ...
        public CustomerAttributeChangesClient(IOptions<ClientsSettings> options, IHttpClientFactory httpClientFactory)
        {
            _url = UriBuilder.Combine(options.Value.ApiHost, "Customers/Attributes/Changes/v1");
        ...
        {
            return _httpClientFactory.PostJsonAsync<CustomerAttributeChangeGetPagedListResponse>(
