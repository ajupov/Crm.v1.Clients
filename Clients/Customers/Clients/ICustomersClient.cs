...
namespace Crm.v1.Clients.Clients.Customers.Clients
{
    public interface ICustomersClient
    {
        ...
        Task<Guid> CreateAsync(Customer lead, Dictionary<string, string> headers, CancellationToken ct = default);

        Task UpdateAsync(Customer lead, Dictionary<string, string> headers, CancellationToken ct = default);
