...
namespace Crm.v1.Clients.Tasks.Clients
{
    ...
    {
        Task<TaskType> GetAsync(Guid id, Dictionary<string, string> headers, CancellationToken ct = default);
        ...
        Task<Guid> CreateAsync(TaskType type, Dictionary<string, string> headers, CancellationToken ct = default);

        Task UpdateAsync(TaskType type, Dictionary<string, string> headers, CancellationToken ct = default);
