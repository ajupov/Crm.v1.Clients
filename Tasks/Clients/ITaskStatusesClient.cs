...
namespace Crm.v1.Clients.Tasks.Clients
{
    ...
    {
        Task<CrmTaskStatus> GetAsync(Guid id, Dictionary<string, string> headers, CancellationToken ct = default);
        ...
        Task UpdateAsync(CrmTaskStatus status, Dictionary<string, string> headers, CancellationToken ct = default);
