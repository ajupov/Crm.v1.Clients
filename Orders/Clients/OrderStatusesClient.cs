...
namespace Crm.v1.Clients.Orders.Clients
{
    public class OrderStatusesClient : IOrderStatusesClient
    {
        ...
        public Task<OrderStatus> GetAsync(Guid id, Dictionary<string, string> headers, CancellationToken ct = default)
        {
        ...
        public Task UpdateAsync(OrderStatus status, Dictionary<string, string> headers, CancellationToken ct = default)
        {
