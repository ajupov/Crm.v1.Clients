...
namespace Crm.v1.Clients.Orders.Clients
{
    public class OrderChangesClient : IOrderChangesClient
    {
        ...
        public OrderChangesClient(IOptions<ClientsOptions> options, IJsonHttpClientFactory factory)
        {
        ...
        {
            return _factory.PostAsync<OrderChangeGetPagedListResponse>(
                _host + "/Orders/Changes/v1/GetPagedList", null, request, headers, ct);
        }
    }
}
