...
namespace Crm.v1.Clients.Orders.Clients
{
    ...
    {
        Task<OrderAttribute> GetAsync(Guid id, Dictionary<string, string> headers, CancellationToken ct = default);
        ...
        Task UpdateAsync(OrderAttribute attribute, Dictionary<string, string> headers, CancellationToken ct = default);
