...
namespace Crm.v1.Clients.Customers.Clients
{
    ...
    {
        Task<Customer> GetAsync(Guid id, Dictionary<string, string> headers, CancellationToken ct = default);
        ...
        Task<Guid> CreateAsync(Customer customer, Dictionary<string, string> headers, CancellationToken ct = default);

        Task UpdateAsync(Customer customer, Dictionary<string, string> headers, CancellationToken ct = default);
